...
export function Home() {
  ...
  const [autoPlayAudio, setAutoPlayAudio] = useState(true) // Updated: autoPlayAudio starts as true
  const [isLandingPage, setIsLandingPage] = useState(true) // Added state variable
  const [feedBottomMargin, setFeedBottomMargin] = useState(120) // Default 100px, adjust as needed
  const [showPrivacyNotice, setShowPrivacyNotice] = useState(true) // Added state variable
                ...
                <form onSubmit={handleSubmit} className="w-full relative">
                  <div className="relative w-full flex items-center">
                    ...
                    <input
                      ...
                      className="w-full rounded-full bg-white px-5 py-4 pb-4 pr-28 text-lg outline-none focus:ring-2 focus:ring-[#a86774] text-left"
                    ...
                    <button
                      type="submit"
                      className={`absolute ${isInitialView ? "right-1" : "right-12"} top-1/2 -translate-y-1/2 rounded-full bg-[#a86774] p-2 text-white hover:bg-[#b87884] focus:outline-none focus:ring-2 focus:ring-[#a86774] focus:ring-offset-2 mr-2`}
                      disabled={isLoading}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isInitialView && (
                      <button
                        ...
                        className={`absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-2 ml-4 ${
                          autoPlayAudio ? "bg-[#a86774] text-white" : "bg-white text-[#a86774]"
                        } hover:bg-[#b87884] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#a86774] focus:ring-offset-2 group`}
